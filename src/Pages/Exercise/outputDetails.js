          ...
          {status === "compiled" && (
            <>
              ...
              <div className="mt-1 overflow-auto rounded-md bg-[#2a4555e1] text-sm font-normal text-white">
                <pre className="p-2 font-normal text-white xt-sm p2">
                  {Buffer.from(
        ...
        {status !== "error" && (
          <div className="flex flex-col w-2/6">
            <div className="sticky top-0">
              ...
              <div className="max-h-full p-2 text-sm font-medium break-words transition duration-200 bg-orange-200 rounded-md text-amber-800">
